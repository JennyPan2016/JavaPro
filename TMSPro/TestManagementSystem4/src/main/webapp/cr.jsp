...
<section id="main" class="p-relative" role="main">
    ...
    <section id="content" class="container">
        <h4 class="page-title">变更CR</h4>
        <!-- Modal -->
        <div class="block-area" id="modal">
            <!-- Create Btn -->
            <div class="m-b-20">
                <button class="btn btn-lg m-r-5" data-toggle="modal" href="#modalWider">Create CR</button>
            </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" class="form-control m-b-10" id="NewName1" placeholder="变更名称">
                                </div>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control m-b-10" id="NewName2" placeholder="变更简述">
                                </div>
                                <div class="col-md-6">
        ...
        <div class="block-area">
            <div class="row">
                ...
                <div class="col-md-3 m-b-10">
                    <input class="form-control input-sm" type="text" placeholder="变更名称">
                </div>

...
public class DeliverListDAO {
	 ...
	 * */
	public List<DeliverList> queryDeliverListsByCenter(String centerName){  
		PreparedStatement pstmt = null;
		Connection conn = new ConnectionDB().connectionDB();
		ResultSet rs = null;
	 ...
	 * */
	public List<DeliverList> queryDeliverListsByGroup(String groupName){  
		PreparedStatement pstmt = null;
		Connection conn = new ConnectionDB().connectionDB();
		ResultSet rs = null;
		List<DeliverList> list = new ArrayList<DeliverList>();
	 ...
	 * */
	public List<DeliverList> queryDeliverListsByDate(String startTime, String endTime){
		PreparedStatement pstmt = null;
		Connection conn = new ConnectionDB().connectionDB();
		ResultSet rs = null;
		List<DeliverList> list = new ArrayList<DeliverList>();
		try {
			String sql = "select * from ProcessPlatform..DeliverList where createTime >= ? and createTime<= ?";				
			pstmt = conn.prepareStatement(sql);			
	 ...
	 * */
	public Map<String, Integer> queryProAndTaskId(String taskName) {   	
		Connection conn = new ConnectionDB().connectionDB();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
...
//测试
	public static void main(String[] args) {
		...
		List<DeliverList> list = new ArrayList<DeliverList>();
		list = dListDAO.queryDeliverListsByDate("2017-04-18", "2017-04-19");

...
public class RollBackInfo {
	...
	public Integer getBackCategoryId() {
		return backCategoryId;
	}
	public void setBackCategoryId(Integer backCategoryId) {
		this.backCategoryId = backCategoryId;
	}
	public Integer getBackGroupId() {
		return backGroupId;
	}
	public void setBackGroupId(Integer backGroupId) {
		this.backGroupId = backGroupId;
	}

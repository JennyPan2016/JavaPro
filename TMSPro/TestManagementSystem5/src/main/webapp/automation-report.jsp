        ...
        <div class="block-area">
            ...
            <div class="row">
                ...
                <div class="col-md-6 m-b-10">
                    <p class="label-name">Remark</p>
                    <textarea class="input-sm validate[required] form-control m-b-10" rows=1></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 m-b-10">
                    <p class="label-name">Bug Link</p>
                    <textarea class="input-sm validate[required] form-control m-b-10" rows=5></textarea>
                </div>
                <div class="col-md-6 m-b-10">
                    <p class="label-name">Report URL</p>
                    <textarea class="input-sm validate[required] form-control m-b-10" rows=5></textarea>
                </div>
            </div>
            <div class="row">
                ...
                <table class="table table-bordered table-hover tile">
                    ...
                    <tbody>
                        <tr class="smokingtablestyle">
                            ...
                            <td>100%</td>
                            <td>
                                <a class="dropdown-toggle underline" href="###" onclick="window.open('http://10.3.2.133:8888/run/detail?runid=36200');">
                                    查看详情</a>
                            </td>
                        </tr>
                    </tbody>
